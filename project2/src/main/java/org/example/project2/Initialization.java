...
public class Initialization {
    ...
    public Variable coalAnnChangeProdTwh = new CoalAnnChangeProdTwh(Arrays.asList(new Label("smallCoalAnnualChange", new FuzzySet(new ClassicSet(-1605, 2440), new TrapezoidalFunction(-1605, -1605, -300, -50, -1605, -50)), VariablesEnum.ANN_COAL_CHANGE_PROD_TWH.getName()),
            new Label("averageCoalAnnualChange", new FuzzySet(new ClassicSet(-1605, 2440), new TrapezoidalFunction(-300, 0, 100, 250, -300, 250)), VariablesEnum.ANN_COAL_CHANGE_PROD_TWH.getName()),
    ...
    public Variable coalProd = new CoalProd(Arrays.asList(new Label("smallCoalProd", new FuzzySet(new ClassicSet(0, 25620), new TrapezoidalFunction(0, 0, 2, 4, 0, 4)), VariablesEnum.COAL_PROD.getName()),
            new Label("averageCoalProd", new FuzzySet(new ClassicSet(0, 25620), new GaussianFunction(101, 33, 2, 200)), VariablesEnum.COAL_PROD.getName()),
            new Label("bigCoalProd", new FuzzySet(new ClassicSet(0, 25620), new TrapezoidalFunction(150, 500, 25620, 25620, 150, 25620)), VariablesEnum.COAL_PROD.getName())));
    ...
    public Variable gasProd = new GasProd(Arrays.asList(new Label("smallGasProd", new FuzzySet(new ClassicSet(0, 10000), new TrapezoidalFunction(0, 0, 10, 40, 0, 40)), VariablesEnum.GAS_PROD.getName()),
            new Label("averageGasProd", new FuzzySet(new ClassicSet(0, 10000), new GaussianFunction(257.5, 80.83, 15, 500)), VariablesEnum.GAS_PROD.getName()),
    ...
    public Variable oilProd = new OilProd(Arrays.asList(new Label("smallOilProd", new FuzzySet(new ClassicSet(0, 8835), new TrapezoidalFunction(0, 0, 30, 50, 0, 50)), VariablesEnum.OIL_PROD.getName()),
            new Label("averageOilProd", new FuzzySet(new ClassicSet(0, 8835), new GaussianFunction(515, 161.67, 30, 1000)), VariablesEnum.OIL_PROD.getName()),
    ...
    Quantifier aroundHalf = new Quantifier("AROUND HALF", new FuzzySet(new ClassicSet(0, 1), new GaussianFunction(0.5, 0.07, 0.3, 0.7)), QuantifierType.RELATIVE);
